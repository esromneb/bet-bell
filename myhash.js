...
// var iipu = b64todata('UE9TVAovYXBwcy8yNzU5MjgvZXZlbnRzCmF1dGhfa2V5PTQ1NGY0NWViZjY4ODBkNjQ1NDljJmF1dGhfdGltZXN0YW1wPTE0ODEzNTA4OTEmYXV0aF92ZXJzaW9uPTEuMCZib2R5X21kNT0xNWQyNTFiMzUzMDZhNmRhN2VmYTUxNWEwZTk3MWY4MA==');
// var mmy = myhmac(iipu, $secret);
// console.log(mmy.get());
// for x in mmy:
//var mmy = myhmac('a', 'secret');
// var decode = new TextDecoder("utf-8").decode(mmy);
// console.log(mmy);
